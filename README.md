...
* Dates of U.S. and international recessions as inferred by GDP-based recession indicator from the Federal Reserve.
...
Our goal is to utilize the tools we have at our disposal to develop an algorithm which will indicate how long the recession will continue due to Covid-19. One of the questions we hope to answer is whether or not one  can predict the length of this current downturn due to the Pandemic by looking for clues in economic and market data from our historical periods?
